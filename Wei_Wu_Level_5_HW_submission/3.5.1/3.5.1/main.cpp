...
int main()
{
	...
	cout << sp->ToString() << endl; // What is printed?
									// It will print the ToString function in the point class 
									// because the virtual function tells the program to go look 
									// and see if there are any more-derived versions of the function available.
