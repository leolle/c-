...
int main()
{
	...
	cout << "pdf: " << pdf(myExponential, scaleParameter) << endl;
	cout << "cdf: " << cdf(myExponential, scaleParameter) << endl;

	// Choose another data type and now a Po(1) variate
	...
	cout << "pdf: " << pdf(myExponential2,scaleParameter) << endl;
	cout << "cdf: " << cdf(myExponential2,scaleParameter) << endl;
	...
	cout << "characteristic function: " << chf(myExponential, scaleParameter) << endl;
	cout << "hazard: " << hazard(myExponential, scaleParameter) << endl;
